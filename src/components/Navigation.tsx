...
const links = [
  ...
  { href: '/programs', label: 'Programs', icon: ListPlus },
    ...
    <nav className="fixed top-0 left-0 right-0 z-50 glass print:hidden">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16 gap-2">
          ...
          <div className="hidden md:flex items-center gap-0.5 flex-1 min-w-0 overflow-x-auto px-2 justify-center">
            {links.map((link) => {
              ...
              return (
                <Link
                  ...
                  to={link.href}
                  className={cn(
                    'relative flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-colors shrink-0',
                    active
                      ? 'text-primary'
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="md:hidden border-t border-border overflow-hidden bg-card/95 backdrop-blur-xl max-h-[70vh] overflow-y-auto"
          >
